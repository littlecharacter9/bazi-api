...
1. 大运性质
    - 十神属性：（当前大运的天干地支十神组合，说明理由）
    - 五行倾向：（当前大运对八字五行的整体影响，说明理由）
    - 运势基调：（这十年整体运势的基调，说明理由）
2. 大运对命局的影响
    - 对日主的影响：（大运是生扶日主还是克制日主，说明理由）
    - 对喜用神的影响：（大运对喜用神是帮助还是压制，说明理由）
    - 对忌神的影响：（大运对忌神是化解还是加重，说明理由）
...
四、下一大运展望（{da_yun_data['next']['干支'] if da_yun_data and da_yun_data['next'] else '未知'}，{da_yun_data['next']['年龄范围'] if da_yun_data and da_yun_data['next'] else '未知'}）
1. 大运性质
